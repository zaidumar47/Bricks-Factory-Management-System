		...
		<form method="post" id="create_invoice">
			...
			<div id="invoice_totals" class="padding-right row text-right">
				...
				<div class="col-xs-6 no-padding-right">
					...
					<div class="row">
						<div class="col-xs-4 col-xs-offset-5">
							<strong>CGST/SGST 18%:</strong><br>Remove CGST/SGST <input type="checkbox" class="remove_vat">
						</div>
						<div class="col-xs-3">
							<?php echo CURRENCY ?><span class="invoice-vat" data-enable-vat="<?php echo ENABLE_VAT ?>" data-vat-rate=18"<?php echo VAT_RATE ?>" data-vat-method="<?php echo VAT_INCLUDED ?>">0.00</span>
